...
scenic_PD_prod = {
    ...
    'dir_init': '/p/data1/jibg31/CLM5_EU3_SCENIC/PD/restart/',
    'file_init': 'CLM5-EUR0275-BGC_SCENIC_PD_prod_JR.clm2.r.2019-01-01-00000.nc',

    'dir_forcing': '/p/scratch/cjibg31/jibg3105/CESMDataRoot/InputData/Forcings/SCENIC/3km/',
...
scenic_2K_spinup = {
    ...
    'dir_script': '/p/project/cjibg31/jibg3105/clm5.0/cime/scripts',
    'name': 'CLM5-EUR0275-BGC_SCENIC_2K_prod_JR',
    'compset': '2000_DATM%CRUv7_CLM50%BGC-CROP_SICE_SOCN_MOSART_SGLC_SWAV',
    'partition': 'dc-cpu',
    'n_cpu': 1024,
    'ncpl': 48,
